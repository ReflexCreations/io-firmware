...
Copied from [hathach's tinyusb repo at version 0.6.0](https://github.com/hathach/tinyusb/releases/tag/0.6.0) and then removed all the files we didn't need for this project.
